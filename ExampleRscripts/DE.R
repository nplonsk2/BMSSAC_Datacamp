...
### To run this script you need to follow the blue comments and change to your specific experimental conditions. Here is a video https://video.kent.edu/media/Kaltura+Capture+recording+-+October+14th+2020%2C+12A17A12+pm/1_9d2vaz7w instructions. 
###When you have made changes to your specific pheno_data.csv file and have a gene_count_matrix with TPM or RPKM of other normalization also included in the folder on github. 
###To run the actual script copy and paste the following commmand Rscript /path/to/your/downloaded/script/DE.R /directory/where/gene_count_matrix
